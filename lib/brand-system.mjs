...
export const brandSystem = Object.freeze({
  ...
  primaryMark: Object.freeze({
    ...
    padding: 10,
    accents: 0,
    curveRendering: "expanded filled paths",
    scaleBehavior: "proportional",
  ...
  scaleReferences: Object.freeze([
    Object.freeze({ size: 24, layers: 12, label: "Primary", role: "Small icon only" }),
    Object.freeze({ size: 40, layers: 12, label: "Primary", role: "Compact navigation" }),
    ...
    Object.freeze({ size: 144, layers: 12, label: "Primary", role: "Display and editorial" }),
  ]),
